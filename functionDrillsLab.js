...
printName('passing in an argument')
...
let nameGreeting = nameCheck("Draden")
...
function faveColorFinder (color){
  if(color === `red`){
    ...
    return `${color} you need to evaluate your favorite color choice`
  }
}
...
let emailCheck1 = emailCheck('@email')
...
let totalFrogs = chocolateFrogs(99)
